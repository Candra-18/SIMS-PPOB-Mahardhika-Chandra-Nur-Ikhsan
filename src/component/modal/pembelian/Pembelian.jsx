...
const Pembelian = ({ isVisible, toggleModal, toggleModalHandleLanjut, amount, name }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 text-center">
              ...
              <h4 className="mb-5 text-lg font-semibold text-black dark:text-gray-400">Pembayaran {name} senilai</h4>
              <h2 className="mb-5 text-lg font-bold text-black dark:text-gray-400">Rp {amount}?</h2>
              <button
                onClick={() => toggleModalHandleLanjut()}
                type="button"
